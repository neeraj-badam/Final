	...
	<div class="container-fluid">
   	...
   	if(username == null || !username.equals("admin"))
   	{
		...
		<div class="row">
            ...
            <div class="col-lg-6">
                : <input type="number" id="cubes" onchange="createTable()"  name="cubes" value='3' required  size=30 style='width:300px'>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-3">
   	                    ...
   	                    else
   	                    {
   	                        switch(c)
   	                        {
   	                            case 1 : add = "<td>"+(r+1)+"</td>";
   	                                     break;
   	                            case 2 : add = "<td>"+"<input type='number' required size='10' value='150' style='width:100px;' id='dimension"+r+"' name='dimension"+r+"' class='dimension"+r+"' onchange='Area()'> x <input type='number' value='150' size='10' style='width:100px;'  name='dimension"+r+"' class='dimension"+r+"' disabled> x <input type='number' value='150' size='10' style='width:100px;'  name='dimension"+r+"' class='dimension"+r+"' disabled>"+"</td>";
   	                                     break;
   	                            case 3 : add = "<td>"+"<input type='number' required name='area"+r+"' value='22500' id='area"+r+"'>"+"</td>";
   	                                     break;
